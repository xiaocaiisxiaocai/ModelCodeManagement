...
const UserManagementPageEnhanced = React.lazy(() => import('../pages/admin/UserManagementPageEnhanced'));
const RoleManagementPageEnhanced = React.lazy(() => import('../pages/admin/RoleManagementPageEnhanced'));
...
export const router = createBrowserRouter([
  ...
  },
  {
    ...
    element: (
      <ProtectedRoute requiredPermissions={['USER_MANAGE']}>
        {withSuspense(UserManagementPageEnhanced)}
      </ProtectedRoute>
    ),
  },
  {
    path: '/admin/roles-enhanced',
    element: (
      <ProtectedRoute requiredPermissions={['ROLE_MANAGE']}>
        {withSuspense(RoleManagementPageEnhanced)}
      </ProtectedRoute>
    ),
  },
  {
  ...
  future: {
    // 在 v7 中，React.startTransition 将被默认用于路由更新
